...
def render_attendance():
    ...
    if st.session_state.members and st.session_state.meetings:
        ...
        st.info("Import members and add meetings below to view the table.")
    ...
    with st.container():
        ...
        meeting_name = st.text_input("Enter meeting name", placeholder="e.g., Team Meeting 1", key="meeting_name_input")
